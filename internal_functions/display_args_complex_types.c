...
void display_and_count_float(va_list ptr, __attribute__((unused)) int *count)
{
...
void display_and_count_double(va_list ptr, __attribute__((unused)) int *count)
{
    double to_print = va_arg(ptr, double);
...
void
display_and_count_long_double(va_list ptr, __attribute__((unused)) int *count)
{
    double to_print = va_arg(ptr, double);
